...
<html lang="en">
    ...
    <body>
        ...
        <div class="container mt-5">
            <div class="row">
                <button class="btn btn-primary col-md-1" onclick="showDiv(1)">Single</button>
                <button class="btn btn-primary col-md-1 ms-1" onclick="showDiv(2)">Double</button>

                <button class="btn btn-primary col-md-1 ms-1   md-1 " onclick="showDiv(5)">Custom</button>
                <div class="row mt-2">
                    <button class="btn btn-primary col-md-1" onclick="showDiv(3)">Queen</button>
                    <button class="btn btn-primary col-md-1 ms-1" onclick="showDiv(4)">King</button>
                </div>
